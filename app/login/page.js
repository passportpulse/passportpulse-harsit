...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-deep-space text-white flex items-center justify-center p-4">
      <div className="glass-card w-full max-w-sm pt-2 pb-8 px-8 rounded-lg text-center">
        <Image width="200" height="200" src="/logo-new.png" alt="Passport Pulse Logo" className=" w-56 -mb-3 mx-auto"/>
