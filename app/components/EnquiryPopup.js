    ...
    return (
        <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label className="text-white text-left text-sm mb-1 block">Security Code:</label>
                    <div className="flex items-center gap-4">
                        ...
                        <input
                            ...
                            className="flex-1 p-3 text-sm rounded-lg bg-black/30 border border-white/10 focus:border-[var(--neon-cyan)] focus:ring-1 focus:ring-[var(--primary-glow)] focus:outline-none transition-colors text-white uppercase"
                        />
                        <button
                            type="button"
