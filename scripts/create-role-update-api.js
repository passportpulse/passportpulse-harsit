// Create API endpoint to update user role
console.log('=== CREATING ROLE UPDATE API ===');
...
const routePath = '/app/api/admin/users/[id]/route.js';
const fullPath = path.join(__dirname, '..', routePath);

try {
  fs.writeFileSync(fullPath, apiRoute);
  console.log('✅ API route created:', routePath);
} catch (error) {
  console.error('❌ Failed to create API route:', error);
}
